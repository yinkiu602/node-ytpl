...
module.exports = (startVideo, mixID, callback) => {
  const request = HTTPS.get(`https://www.youtube.com/watch?v=${startVideo}&list=${mixID}&hl=en&disable_polymer=true`, resp => { // eslint-disable-line consistent-return, max-len
